...
const statusFor = (code: string): number => {
  ...
  if (["SLOT_NO_LONGER_AVAILABLE", "SLOT_CONFLICT", "IDEMPOTENCY_CONFLICT", "APPOINTMENT_VERSION_CONFLICT", "APPOINTMENT_OPERATION_IN_PROGRESS"].includes(code)) return 409;
