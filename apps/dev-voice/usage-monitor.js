...
const styles = `:host{display:block;color:#eef0fa;font:12px "Trebuchet MS",Avenir,system-ui}section{width:92%;margin:0 auto;background:transparent;border:0;border-top:1px solid #5267be;border-radius:0;box-shadow:none;overflow:hidden}header{display:flex;align-items:center;justify-content:space-between;padding:11px 3px 8px;background:transparent;color:white}header>div{display:flex;align-items:baseline;gap:10px}header small{color:#f7d774;font-size:8px;letter-spacing:.14em}header strong{font:500 17px Georgia,"Times New Roman",serif}header>span{font-size:9px;color:#c5cbe5}header>span i{display:inline-block;width:7px;height:7px;margin-right:6px;border-radius:50%;background:#6fd5c5;box-shadow:0 0 0 0 #6fd5c588;animation:live 1.8s infinite}.billing{display:flex;align-items:center;gap:12px;padding:7px 3px;border-block:1px solid #5267be}.billing span{color:#c5cbe5;font-size:10px}.billing code{color:#f7d774}.billing.loading{color:#c5cbe5}.billing.setup{background:transparent}.billing.failed{background:#ff695714}.billing.synced{justify-content:space-between;background:#6fd5c510}.billing.synced>span{display:flex;align-items:baseline;gap:8px}.billing.synced small{font-size:8px;letter-spacing:.1em}.billing.synced strong{font-size:16px;color:#f7d774}.metrics{display:grid;grid-template-columns:repeat(5,1fr);background:transparent;border-bottom:1px solid #5267be}.metrics article{display:flex;align-items:center;gap:9px;padding:13px 15px;background:transparent;border-right:1px solid #5267be;transition:.25s}.metrics article:last-child{border-right:0}.metrics article:nth-child(2),.metrics article:nth-child(4){background:transparent;color:#eef0fa}.metrics article>i{font-style:normal;font-size:15px;color:#f7d774}.metrics article small{display:block;font-size:8px;letter-spacing:.08em;text-transform:uppercase;color:#b7bfdf}.metrics article strong{font:500 18px Georgia,"Times New Roman",serif;color:white}.metrics article.changed{animation:pop .55s ease;background:#6fd5c51c}footer{display:flex;justify-content:space-between;align-items:center;padding:7px 3px 12px;color:#a9b1d4;font-size:9px}footer button{border:0;background:transparent;color:#f7d774;font:700 9px inherit;cursor:pointer}@keyframes live{70%{box-shadow:0 0 0 7px #6fd5c500}}@keyframes pop{45%{transform:translateY(-2px);color:#fff}}@media(max-width:850px){section{width:90%}.metrics{grid-template-columns:repeat(2,1fr)}.metrics article{border-bottom:1px solid #5267be}.metrics article:last-child{grid-column:1/-1}.billing.synced{align-items:flex-start}.billing.synced>span{display:grid}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important}}`;
