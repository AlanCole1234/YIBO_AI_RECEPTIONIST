...
export const messages = {
  "es-MX": {
    ...
    homeSubtitle: "Tu operación esencial, reunida en un solo vistazo.", testAgent: "Probar agente",
    calendarReady: "Calendario conectado", calendarSetup: "Calendario por conectar", calendarMissing: "Calendario pendiente",
    calendarReadyHelp: "Las citas pueden sincronizarse con", calendarSetupHelp: "Conecta el calendario de prueba antes de crear citas reales.",
    calendarMissingHelp: "Añade las variables de Google Calendar y la llave de cifrado en tu archivo .env local.",
    connectCalendar: "Conectar calendario", reconnectCalendar: "Reconectar calendario", notConfigured: "Sin configurar",
  ...
  "en-US": {
    ...
    homeSubtitle: "Your essential operation, gathered in one glance.", testAgent: "Test the agent",
    calendarReady: "Calendar connected", calendarSetup: "Calendar needs connection", calendarMissing: "Calendar pending",
    calendarReadyHelp: "Appointments can sync with", calendarSetupHelp: "Connect the test calendar before making real bookings.",
    calendarMissingHelp: "Add the Google Calendar values and encryption key to your local .env file.",
    connectCalendar: "Connect calendar", reconnectCalendar: "Reconnect calendar", notConfigured: "Not configured",
